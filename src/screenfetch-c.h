...
char* solaris_logo[] =
{
	...
	"MMMMMMMMMMMMMMMMMMMMMMMMMMMMMZZMMMMM+:MMMM$MMMMMMMMMMMM",
	"MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM:8MMM::MMMM:OMMMMMMMMMMM",
	"MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMD::MM~::MM:::MMMMMOMMMMMM",
	"MMMMMMMMMMMMMMMMMMMMMMMMMM~~MMM:::+MMMMN~~7MM~~:MMMMMMM",
	"MMMMMMMMMMMMMMMMMMMMMMMMMMM~~~7MMMMMMMMMMMM7~~~MMMMMMMM",
	"MMMMMMMMMMMMMMMMMMMMMMMMMMM~~MMMMMMMMMMMMMMMM~MMMMMNMMM",
	"MMMMMMMMMMMMMMMMMMMMMII~~IM8MMMMMMMMMMMMMMMMMM?~~~~OMMM",
	"MMMMMMMMMMMMMMMMMMMMMMMM=~~MMMMMMMMMMMMMMMMMMMM=?MMMMMM",
	"MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM",
	"MMMI++NMMMMM7=+$MMMM??MMMMMM7+=7MMMM8ZMM?+MMZOMMMN?=7MM",
	"M$~~DMOMMM=~=8Z~~=MM=~MMMMZ=8ZZ~~MMMZ~=~==MM~=MM=~+MM?M",
	"M=~7MMMMMI~=MMMM~~MM~~MMMMMMMMM8~=MMZ~~MMMMM~=MM~~MMMMM",
	"MM=~~~?MM~~?MMMM~~MM~~MMMMM?~~~~~=MMZ~~MMMMM~=MMO~~~~MM",
	"MMMMM=::M=:~MMMM::MM~:MMMM~:MMM8:=MMZ::MMMMM:=MMMMMN::O",
	"MMMMMM::M8::MMM~::MM::MMMM::MMM=:~MM$::MMMMM:~MMMMMM~:I",
	"M::::::MMMM:,,,,OMMM=,:,OM$:,,:8:~MM$::MMMMM:~MM,:::,?M"
};
